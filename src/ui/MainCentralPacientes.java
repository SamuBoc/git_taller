...
public class MainCentralPacientes {
	...
	private void agregarPaciente() {
        ...
        sc.nextLine();
        System.out.println("Digite la fecha del nacimiento del paciente:");
    	...
    	String output = central.agregarPaciente(code, fechaNacimiento, nombre);
    	System.out.println(output);
    ...
    public void feature2(){
        System.out.println("Hola, soy nicho");
    }
